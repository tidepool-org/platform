...
var _ = Describe("Errors", func() {
	DescribeTable("all errors",
		...
		Entry("is ErrorTypeNotBoolean with int parameter", service.ErrorTypeNotBoolean(0), "type-not-boolean", "type is not boolean", "Type is not boolean, but int", 0),
		...
		Entry("is ErrorTypeNotInteger with int parameter", service.ErrorTypeNotInteger(0), "type-not-integer", "type is not integer", "Type is not integer, but int", 0),
		...
		Entry("is ErrorTypeNotFloat with int parameter", service.ErrorTypeNotFloat(0), "type-not-float", "type is not float", "Type is not float, but int", 0),
		...
		Entry("is ErrorTypeNotString with int parameter", service.ErrorTypeNotString(0), "type-not-string", "type is not string", "Type is not string, but int", 0),
		...
		Entry("is ErrorTypeNotObject with int parameter", service.ErrorTypeNotObject(0), "type-not-object", "type is not object", "Type is not object, but int", 0),
		...
		Entry("is ErrorTypeNotArray with int parameter", service.ErrorTypeNotArray(0), "type-not-array", "type is not array", "Type is not array, but int", 0),
		...
		Entry("is ErrorValueIntegerNotInRange", service.ErrorValueIntegerNotInRange(1, 2, 3), "value-out-of-range", "value is out of range", "Value 1 is not between 2 and 3", 0),
		Entry("is ErrorValueFloatNotInRange", service.ErrorValueFloatNotInRange(1.4, 2.4, 3.4), "value-out-of-range", "value is out of range", "Value 1.4 is not between 2.4 and 3.4", 0),
