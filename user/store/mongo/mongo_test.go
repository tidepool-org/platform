...
// 						Expect(mongoSession.DeleteUser(nil)).To(MatchError("user is missing"))
// 					})

// 					It("returns an error if the user id is missing", func() {
// 						deleteUser.ID = ""
// 						Expect(mongoSession.DeleteUser(deleteUser)).To(MatchError("user id is missing"))
// 					})

// 					It("returns an error if the session is closed", func() {
// 						mongoSession.Close()
// 						Expect(mongoSession.DeleteUser(deleteUser)).To(MatchError("session closed"))
// 					})
...
// 					It("returns an error if the user id is missing", func() {
// 						Expect(mongoSession.DestroyUserByID("")).To(MatchError("user id is missing"))
// 					})

// 					It("returns an error if the session is closed", func() {
// 						mongoSession.Close()
// 						Expect(mongoSession.DestroyUserByID(destroyUserID)).To(MatchError("session closed"))
// 					})
