...
var _ = Describe("Config", func() {
	...
	Context("NewLoader", func() {
		It("returns an error if environment reporter is missing", func() {
			loader, err := config.NewLoader(nil, "_fixtures/config")
