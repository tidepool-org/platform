...
// //AuthorizationMiddlewareOld is used for validation of incoming tokens
// type AuthorizationMiddlewareOld struct {
// 	Client Client
// }

// //NewAuthorizationMiddlewareOld creates an initialised AuthorizationMiddlewareOld
// func NewAuthorizationMiddlewareOld(userClient Client) *AuthorizationMiddlewareOld {
// 	return &AuthorizationMiddlewareOld{Client: userClient}
// }

// //ValidateToken returns if valid or sends http.StatusUnauthorized if invalid
// func (mw *AuthorizationMiddlewareOld) ValidateToken(h rest.HandlerFunc) rest.HandlerFunc {

// 	return func(w rest.ResponseWriter, r *rest.Request) {

// 		token := r.Header.Get(xTidepoolSessionToken)

// 		if tokenData, err := mw.Client.ValidateSessionToken(token); err == nil && tokenData != nil {
// 			h(w, r)
// 			return
// 		}
