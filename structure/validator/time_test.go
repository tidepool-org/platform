...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeNotZero(value)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeNotAfter(value, time.Unix(1451567655, 0).UTC())}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeNotAfterNow(value)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeNotBefore(value, time.Unix(1451567655, 0).UTC())}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeNotBeforeNow(value)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueTimeZero(value)}))
// 			})
