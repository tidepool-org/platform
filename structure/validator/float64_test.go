...
var _ = Describe("Float64", func() {
	...
	Context("with new validator with value of 1.2", func() {
		...
		Context("GreaterThan", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotGreaterThan(1.2, 3))
			})
		...
		Context("GreaterThanOrEqualTo", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotGreaterThanOrEqualTo(1.2, 4.5))
			})
	...
	Context("with new validator with value of 4.5", func() {
		...
		Context("EqualTo", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotEqualTo(4.5, 1.2))
			})
		...
		Context("NotEqualTo", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueEqualTo(4.5, 4.5))
			})
		...
		Context("LessThan", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotLessThan(4.5, 3))
			})
		...
		Context("LessThanOrEqualTo", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotLessThanOrEqualTo(4.5, 1.2))
			})
		...
		Context("InRange", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueNotInRange(4.5, 0, 3))
			})
		...
		Context("OneOf", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueFloat64NotOneOf(4.5, []float64{1.2, 7.8}))
			})
		...
		Context("NotOneOf", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueFloat64OneOf(4.5, []float64{7.8, 4.5}))
			})
		...
		Context("OneOf with no allowed values", func() {
			...
			It("reports the expected error", func() {
				Expect(base.Error()).To(HaveOccurred())
				errorsTest.ExpectEqual(base.Error(), structureValidator.ErrorValueFloat64NotOneOf(4.5, []float64{}))
			})
