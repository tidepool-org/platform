...
// 				for range value {
// 					base.WithReferenceOutputs = append(base.WithReferenceOutputs, withReference)
// 				}
// 			})

// 			AfterEach(func() {
// 				withReference.Expectations()
// 			})
...
// 				It("reports the expected error", func() {
// 					Expect(base.ReportErrorInputs).To(BeEmpty())
// 					Expect(withReference.ReportErrorInputs).To(Equal([]error{
...
// 				It("reports the expected error", func() {
// 					Expect(base.ReportErrorInputs).To(BeEmpty())
// 					Expect(withReference.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringOneOf("four", []string{"seven", "four"})}))
// 				})
...
// 				It("reports the expected error", func() {
// 					Expect(base.ReportErrorInputs).To(BeEmpty())
// 					Expect(withReference.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringMatches("four", expression)}))
// 				})
