...
// 			It("does not report an error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueEmpty()}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueNotEmpty()}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotGreaterThan(1, 3)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotGreaterThanOrEqualTo(1, 4)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueNotEqualTo("four", "1")}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueEqualTo("four", "four")}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotEqualTo(4, 1)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthEqualTo(4, 4)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotLessThan(4, 3)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotLessThanOrEqualTo(4, 1)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorLengthNotInRange(4, 0, 3)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringNotOneOf("four", []string{"1", "seven"})}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringOneOf("four", []string{"seven", "four"})}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringNotOneOf("four", []string{})}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringNotMatches("four", expression)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringMatches("four", expression)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringNotMatches("four", nil)}))
// 			})
...
// 			It("reports the expected error", func() {
// 				Expect(base.ReportErrorInputs).To(Equal([]error{structureValidator.ErrorValueStringMatches("four", nil)}))
// 			})
