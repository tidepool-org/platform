...
type Session interface {
	...
	List(ctx context.Context, userID string, filter *image.Filter, pagination *page.Pagination) (image.Images, error)
...
func (u *Update) Validate(validator structure.Validator) {
	...
	validator.String("name", u.Name).NotEmpty().LengthLessThanOrEqualTo(image.NameLengthMaximum)
...
func (u *Update) HasUpdates() bool {
	return u.Name != nil || u.ContentID != nil || u.ContentIntent != nil || u.ContentAttributes != nil || u.RenditionsID != nil || u.Rendition != nil
}
