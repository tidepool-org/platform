...
var _ = Describe("Service", func() {
	...
	Context("with started server, config reporter, and new service", func() {
		...
		var server *Server
		var authClientConfig map[string]any
		var authStoreConfig map[string]any
		var dataClientConfig map[string]any
		var dataSourceClientConfig map[string]any
		var taskClientConfig map[string]any
		var permissionClientConfig map[string]any
		var authServiceConfig map[string]any
