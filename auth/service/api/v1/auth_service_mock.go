...
//
//	mockgen -build_flags=--mod=mod -destination=./auth_service_mock.go -package=v1 -mock_names Service=MockAuthService github.com/tidepool-org/platform/auth/service Service
//
...
func (m *MockAuthService) ProfileAccessor() user.ProfileAccessor {
	m.ctrl.T.Helper()
...
func (mr *MockAuthServiceMockRecorder) ProfileAccessor() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProfileAccessor", reflect.TypeOf((*MockAuthService)(nil).ProfileAccessor))
}
...
func (mr *MockAuthServiceMockRecorder) Status(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
