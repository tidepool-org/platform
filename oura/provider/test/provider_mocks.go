...
//
//	mockgen -source=provider.go -destination=test/provider_mocks.go -package=test WorkClient
//
...
// Create mocks base method.
func (m *MockWorkClient) Create(ctx context.Context, create *work.Create) (*work.Work, error) {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockWorkClientMockRecorder) Create(ctx, create any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockWorkClient)(nil).Create), ctx, create)
}

// DeleteAllByGroupID mocks base method.
func (m *MockWorkClient) DeleteAllByGroupID(ctx context.Context, groupID string) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockWorkClientMockRecorder) DeleteAllByGroupID(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAllByGroupID", reflect.TypeOf((*MockWorkClient)(nil).DeleteAllByGroupID), ctx, groupID)
}
