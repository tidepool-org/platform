...
func (w *Work) Validate(validator structure.Validator) {
	validator.String("id", &w.ID).Using(WorkIDValidator)
...
func IsValidWorkID(value string) bool {
	return ValidateWorkID(value) == nil
}

func WorkIDValidator(value string, errorReporter structure.ErrorReporter) {
	errorReporter.ReportError(ValidateWorkID(value))
}

func ValidateWorkID(value string) error {
	if value == "" {
		return structureValidator.ErrorValueEmpty()
	} else if !idExpression.MatchString(value) {
		return ErrorValueStringAsWorkIDNotValid(value)
	}
	return nil
}

func ErrorValueStringAsWorkIDNotValid(value string) error {
