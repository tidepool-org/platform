...
func (mr *MockStoreMockRecorder) Create(ctx, create interface{}) *gomock.Call {
...
func (mr *MockStoreMockRecorder) DeleteAllByGroupID(ctx, groupID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) List(ctx, filter, pagination interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Poll(ctx, poll interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Update(ctx, id, condition, update interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
