...
ifdef TRAVIS_PULL_REQUEST_BRANCH
	docker tag $(DOCKER_REPOSITORY) $(DOCKER_REPOSITORY):PR-${BRANCH}-$(TRAVIS_COMMIT)
else
	docker tag $(DOCKER_REPOSITORY) $(DOCKER_REPOSITORY):${BRANCH)-$(TRAVIS_COMMIT)
endif
endif
endif
ifdef TRAVIS_TAG
...
ifdef TRAVIS_COMMIT
ifdef TRAVIS_PULL_REQUEST_BRANCH
	docker push $(DOCKER_REPOSITORY):PR-$(BRANCH)-$(TRAVIS_COMMIT)
else
	docker push $(DOCKER_REPOSITORY):$(BRANCH)-$(TRAVIS_COMMIT)
endif
endif
endif
ifdef TRAVIS_TAG
