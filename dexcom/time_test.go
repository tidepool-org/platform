...
var _ = Describe("Time", func() {
	Context("ParseTime", func() {
		...
		DescribeTable("does not parse an invalid time string",
			...
			Entry("invalid time string with alternate time zone format -00", "2001-02-03T14:15:16-05"),
			Entry("invalid time string with alternate time zone format +00", "2001-02-03T14:15:16+05"),
			Entry("invalid time string with alternate time zone format -00:00:00", "2001-02-03T14:15:16-05:00:00"),
			Entry("invalid time string with alternate time zone format +00:00:00", "2001-02-03T14:15:16+05:00:00"),
			Entry("invalid time string with alternate time zone format Z00:00", "2001-02-03T14:15:16Z05:00"),
			Entry("invalid time string with alternate time zone format +0000", "2001-02-03T14:15:16+0500"),
		)
