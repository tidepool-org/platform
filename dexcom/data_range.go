...
func (d *DataRangeResponse) Validate(validator structure.Validator) {
	validator.String("recordType", d.RecordType).Exists().EqualTo(DataRangeRecordType)
	validator.String("recordVersion", d.RecordVersion).Exists().NotEmpty()
