...
func (m *MockDexcomClient) GetDataRange(arg0 context.Context, arg1 *time.Time, arg2 oauth.TokenSource) (*dexcom.DataRangeResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDataRange", arg0, arg1, arg2)
	ret0, _ := ret[0].(*dexcom.DataRangeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
