...
//go:generate go tool go.uber.org/mock/mockgen -source=runner.go -destination=test/runner_mocks.go -package=test AuthClient
...
//go:generate go tool go.uber.org/mock/mockgen -source=runner.go -destination=test/runner_mocks.go -package=test DataClient
...
//go:generate go tool go.uber.org/mock/mockgen -source=runner.go -destination=test/runner_mocks.go -package=test DataSourceClient
...
//go:generate go tool go.uber.org/mock/mockgen -source=runner.go -destination=test/runner_mocks.go -package=test DexcomClient
...
//go:generate go tool go.uber.org/mock/mockgen -source=runner.go -destination=test/runner_mocks.go -package=test Provider
