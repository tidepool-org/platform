...
export TIDEPOOL_TASK_QUEUE_DISPATCH_TASKS_INTERVAL="5"
...
export TIDEPOOL_BLOB_SERVICE_UNSTRUCTURED_BLOBS_STORE_TYPE="file"
export TIDEPOOL_BLOB_SERVICE_UNSTRUCTURED_BLOBS_STORE_FILE_DIRECTORY="_data/blobs"

export TIDEPOOL_BLOB_SERVICE_UNSTRUCTURED_LOGS_STORE_TYPE="file"
export TIDEPOOL_BLOB_SERVICE_UNSTRUCTURED_LOGS_STORE_FILE_DIRECTORY="_data/device_logs"
