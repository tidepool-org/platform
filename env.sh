...
export TIDEPOOL_AUTH_CLIENT_EXTERNAL_AUTHENTICATION_ADDRESS=http://localhost:9107
export TIDEPOOL_AUTH_CLIENT_EXTERNAL_AUTHORIZATION_ADDRESS=http://localhost:9123
