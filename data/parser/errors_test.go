...
var _ = Describe("Errors", func() {
	DescribeTable("all errors",
		...
		Entry("ErrorTypeNotBoolean with string array parameter", parser.ErrorTypeNotBoolean([]string{}), "type-not-boolean", "type is not boolean", "Type is not boolean, but []string"),
		...
		Entry("ErrorTypeNotInteger with string array parameter", parser.ErrorTypeNotInteger([]string{}), "type-not-integer", "type is not integer", "Type is not integer, but []string"),
		...
		Entry("ErrorTypeNotFloat with string array parameter", parser.ErrorTypeNotFloat([]string{}), "type-not-float", "type is not float", "Type is not float, but []string"),
		...
		Entry("ErrorTypeNotString with string array parameter", parser.ErrorTypeNotString([]string{}), "type-not-string", "type is not string", "Type is not string, but []string"),
		...
		Entry("ErrorTypeNotObject with string array parameter", parser.ErrorTypeNotObject([]string{}), "type-not-object", "type is not object", "Type is not object, but []string"),
		...
		Entry("ErrorTypeNotArray with string array parameter", parser.ErrorTypeNotArray([]string{}), "type-not-array", "type is not array", "Type is not array, but []string"),
	)
})
