		...
		Context("Validate", func() {
			DescribeTable("return the expected results when the input",
				...
				Entry("DeviceID not long enough",
					...
					errorsTest.WithPointerSource(structureValidator.ErrorLengthNotGreaterThanOrEqualTo(0, pumpstatus.MinDeviceIDLength), "/deviceID"),
				),
				Entry("Model missing",
				...
				Entry("Model not long enough",
					...
					errorsTest.WithPointerSource(structureValidator.ErrorLengthNotGreaterThanOrEqualTo(0, pumpstatus.MinModelLength), "/model"),
				),
				...
				Entry("Manufacturer not long enough",
					...
					errorsTest.WithPointerSource(structureValidator.ErrorLengthNotGreaterThanOrEqualTo(0, pumpstatus.MinManufacturerLength), "/manufacturer"),
				),
