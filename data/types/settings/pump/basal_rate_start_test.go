		...
		Context("Validate", func() {
			DescribeTable("validates the datum",
				func(mutator func(datum *pump.BasalRateStart), expectedErrors ...error) {
					datum := pumpTest.NewBasalRateStart(pump.BasalRateStartStartMinimum)
					mutator(datum)
		...
		Context("Validate", func() {
			DescribeTable("validates the datum",
				...
				Entry("single invalid",
					func(datum *pump.BasalRateStartArray) {
						invalid := pumpTest.NewBasalRateStart(pump.BasalRateStartStartMinimum)
						invalid.Rate = nil
				...
				Entry("single valid",
					func(datum *pump.BasalRateStartArray) {
						*datum = append(*datum, pumpTest.NewBasalRateStart(pump.BasalRateStartStartMinimum))
					},
				),
				Entry("multiple invalid",
					func(datum *pump.BasalRateStartArray) {
						*datum = append(*datum, pumpTest.NewBasalRateStart(pump.BasalRateStartStartMinimum))
						invalid := pumpTest.NewBasalRateStart(*datum.Last().Start + 1)
						invalid.Rate = nil
						*datum = append(*datum, invalid)
						*datum = append(*datum, pumpTest.NewBasalRateStart(*datum.Last().Start+1))
					},
				...
				Entry("multiple errors",
					func(datum *pump.BasalRateStartArray) {
						...
						*datum = append(*datum, nil, pumpTest.NewBasalRateStart(*datum.Last().Start+1))
					},
					errorsTest.WithPointerSource(structureValidator.ErrorValueNotExists(), "/0"),
					errorsTest.WithPointerSource(structureValidator.ErrorValueNotExists(), "/1/rate"),
	...
	Context("BasalRateStartArrayMap", func() {
		...
		Context("Validate", func() {
			DescribeTable("validates the datum",
				...
				Entry("empty name",
					func(datum *pump.BasalRateStartArrayMap) { datum.Set("", pumpTest.NewBasalRateStartArray()) },
				),
				Entry("nil value",
				...
				Entry("single invalid",
					func(datum *pump.BasalRateStartArrayMap) {
						invalid := pumpTest.NewBasalRateStartArray()
						(*invalid)[0].Start = nil
				...
				Entry("single valid",
					func(datum *pump.BasalRateStartArrayMap) {
						datum.Set("one", pumpTest.NewBasalRateStartArray())
					},
				),
				Entry("multiple invalid",
					func(datum *pump.BasalRateStartArrayMap) {
						...
						datum.Set("three", pumpTest.NewBasalRateStartArray())
					},
				...
				Entry("multiple valid",
					func(datum *pump.BasalRateStartArrayMap) {
						datum.Set("one", pumpTest.NewBasalRateStartArray())
						datum.Set("two", pumpTest.NewBasalRateStartArray())
						datum.Set("three", pumpTest.NewBasalRateStartArray())
					},
				),
				Entry("multiple errors",
