		...
		Context("with initialized", func() {
			...
			DescribeTable("Validate",
				...
				Entry("duration in range (upper)",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 86400000, nil, nil),
					[]*service.Error{}),
				Entry("duration out of range (upper)",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 86400001, nil, nil),
					[]*service.Error{
				...
				Entry("expected duration in range (upper)",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 3600000, 86400000, nil),
					[]*service.Error{}),
				Entry("expected duration out of range (upper)",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 3600000, 86400001, nil),
					[]*service.Error{
				...
				Entry("suppressed scheduled multiple",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 3600000, 7200000, NewTestSuppressed("invalid", "scheduled", 20.1, "", NewTestSuppressed(nil, nil, nil, nil, nil))),
					[]*service.Error{
						testing.ComposeError(service.ErrorValueNotEqualTo("invalid", "basal"), "/suppressed/type", NewMeta()),
						testing.ComposeError(service.ErrorValueNotInRange(20.1, 0.0, 20.0), "/suppressed/rate", NewMeta()),
				...
				Entry("suppressed temp with suppressed multiple",
					NewTestSuspend("2016-09-06T13:45:58-07:00", 3600000, 7200000, NewTestSuppressed("basal", "temp", 2.0, nil, NewTestSuppressed("invalid", "scheduled", 20.1, "", NewTestSuppressed(nil, nil, nil, nil, nil)))),
					[]*service.Error{
						testing.ComposeError(service.ErrorValueNotEqualTo("invalid", "basal"), "/suppressed/suppressed/type", NewMeta()),
						testing.ComposeError(service.ErrorValueNotInRange(20.1, 0.0, 20.0), "/suppressed/suppressed/rate", NewMeta()),
			...
			Context("Normalize", func() {
				It("succeeds", func() {
					...
					Expect(testSuspend.Normalize(testNormalizer)).To(Succeed())
				})
			})
		})
	})
