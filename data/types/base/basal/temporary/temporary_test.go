		...
		Context("with initialized", func() {
			...
			DescribeTable("Validate",
				...
				Entry("duration in range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 86400000, nil, 1.0, 0.5, nil),
					[]*service.Error{}),
				Entry("duration out of range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 86400001, nil, 1.0, 0.5, nil),
					[]*service.Error{
				...
				Entry("expected duration in range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 3600000, 86400000, 1.0, 0.5, nil),
					[]*service.Error{}),
				Entry("expected duration out of range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 3600000, 86400001, 1.0, 0.5, nil),
					[]*service.Error{
				...
				Entry("missing duration; expected duration in range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", nil, 86400000, 1.0, 0.5, nil),
					[]*service.Error{
						testing.ComposeError(service.ErrorValueNotExists(), "/duration", NewMeta()),
					}),
				Entry("missing duration; expected duration out of range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", nil, 86400001, 1.0, 0.5, nil),
					[]*service.Error{
						testing.ComposeError(service.ErrorValueNotExists(), "/duration", NewMeta()),
				...
				Entry("rate in range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 3600000, 7200000, 20.0, 0.5, nil),
					[]*service.Error{}),
				Entry("rate out of range (upper)",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 3600000, 7200000, 20.1, 0.5, nil),
					[]*service.Error{
				...
				Entry("multiple",
					NewTestTemporary(nil, nil, 86400001, 20.1, 10.1, nil),
					[]*service.Error{
						testing.ComposeError(service.ErrorValueNotExists(), "/time", NewMeta()),
						testing.ComposeError(service.ErrorValueNotExists(), "/duration", NewMeta()),
						testing.ComposeError(service.ErrorValueNotInRange(86400001, 0, 86400000), "/expectedDuration", NewMeta()),
				...
				Entry("suppressed multiple",
					NewTestTemporary("2016-09-06T13:45:58-07:00", 3600000, 7200000, 1.0, 0.5, NewTestSuppressed("invalid", "scheduled", 20.1, "", NewTestSuppressed(nil, nil, nil, nil, nil))),
					[]*service.Error{
