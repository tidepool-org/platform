	...
	Context("Association", func() {
		...
		Context("Validate", func() {
			DescribeTable("validates the datum",
				...
				Entry("type empty",
					func(datum *association.Association) { datum.Type = pointer.String("") },
					testErrors.WithPointerSource(structureValidator.ErrorValueStringNotOneOf("", []string{"datum", "url"}), "/type"),
				),
				Entry("type invalid",
