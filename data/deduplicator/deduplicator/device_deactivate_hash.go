...
func (d *DeviceDeactivateHash) Delete(ctx context.Context, repository dataStore.DataRepository, dataSet *dataTypesUpload.Upload, doPurge bool) error {
	if ctx == nil {
		return errors.New("context is missing")
	}
	if repository == nil {
	...
	return d.Base.Delete(ctx, repository, dataSet, doPurge)
}
