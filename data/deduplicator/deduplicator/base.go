...
func (b *Base) Delete(ctx context.Context, repository dataStore.DataRepository, dataSet *dataTypesUpload.Upload, doPurge bool) error {
	if ctx == nil {
		return errors.New("context is missing")
	}
	if repository == nil {
	...
	return repository.DeleteDataSet(ctx, dataSet, doPurge)
}
