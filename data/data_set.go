...
type DataSetClient struct {
	...
	Private map[string]any `json:"private,omitempty" bson:"private,omitempty"`
}
...
func (d *DataSetClient) Validate(validator structure.Validator) {
	...
	if d.Private != nil {
		validator.Object("private", &d.Private).NotEmpty().SizeLessThanOrEqualTo(metadata.MetadataSizeMaximum)
	}
}
