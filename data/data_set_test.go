...
var _ = Describe("DataSet", func() {
	...
	Context("IsValidSetID, SetIDValidator, and ValidateSetID", func() {
		DescribeTable("return the expected results when the input",
			...
			Entry("is first version with string length in range", "upid_"+test.RandomStringFromRangeAndCharset(12, 12, test.CharsetHexadecimalLowercase)),
			...
			Entry("is second version with string length in range", "upid_"+test.RandomStringFromRangeAndCharset(32, 32, test.CharsetHexadecimalLowercase)),
			...
			Entry("is third version with string length in range", test.RandomStringFromRangeAndCharset(32, 32, test.CharsetHexadecimalLowercase)),
