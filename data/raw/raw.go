...
type Create struct {
	...
	DigestMD5      *string        `json:"digestMD5,omitempty" bson:"digestMD5,omitempty"`       //nolint:tagliatelle // Backward compatibility
	DigestSHA256   *string        `json:"digestSHA256,omitempty" bson:"digestSHA256,omitempty"` //nolint:tagliatelle // Backward compatibility
...
type Content struct {
	DigestMD5    string        `json:"digestMD5" bson:"digestMD5"`                           //nolint:tagliatelle // Backward compatibility
	DigestSHA256 *string       `json:"digestSHA256,omitempty" bson:"digestSHA256,omitempty"` //nolint:tagliatelle // Backward compatibility // FUTURE: Require - https://tidepool.atlassian.net/browse/BACK-4416
