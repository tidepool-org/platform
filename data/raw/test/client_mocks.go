...
func (mr *MockClientMockRecorder) DeleteAllByDataSetID(ctx, userID, dataSetID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAllByDataSetID", reflect.TypeOf((*MockClient)(nil).DeleteAllByDataSetID), ctx, userID, dataSetID)
}
