...
//go:generate go tool go.uber.org/mock/mockgen -source=client.go -destination=test/client_mocks.go -package=test Store
type Store interface {
	...
	Update(ctx context.Context, id string, condition *storeStructured.Condition, update *dataRaw.Update) (*dataRaw.Raw, error)
	...
	DeleteAllByDataSetID(ctx context.Context, userID string, dataSetID string) (int, error)
...
func (c *Client) Update(ctx context.Context, id string, condition *request.Condition, update *dataRaw.Update) (*dataRaw.Raw, error) {
...
func (c *Client) DeleteAllByDataSetID(ctx context.Context, userID string, dataSetID string) (int, error) {
	return c.store.DeleteAllByDataSetID(ctx, userID, dataSetID)
}
