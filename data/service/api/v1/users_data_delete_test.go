...
// 			context.SyncTaskSessionImpl.DestroySyncTasksForUserByIDOutputs = []error{nil}
...
// 			Expect(context.SyncTaskSessionImpl.DestroySyncTasksForUserByIDInputs).To(Equal([]string{targetUserID}))
...
// 			context.SyncTaskSessionImpl.DestroySyncTasksForUserByIDOutputs = []error{}
...
// 			context.SyncTaskSessionImpl = nil
// 			context.MetricClientImpl.RecordMetricOutputs = []error{}
// 			Expect(func() { v1.UsersDataDelete(context) }).To(Panic())
// 			Expect(context.ValidateTest()).To(BeTrue())
// 		})
...
// 			err := errors.New("other")
// 			context.SyncTaskSessionImpl.DestroySyncTasksForUserByIDOutputs = []error{err}
// 			context.MetricClientImpl.RecordMetricOutputs = []error{}
// 			v1.UsersDataDelete(context)
