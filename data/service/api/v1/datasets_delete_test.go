...
var _ = Describe("DataSetsDelete", func() {
	...
	// 			context.DataRepositoryImpl.GetDataSetByIDOutputs = []testDataStoreDEPRECATED.GetDataSetByIDOutput{{DataSet: targetUpload, Error: nil}}
	...
	// 			context.DataRepositoryImpl.DeleteDataSetOutputs = []error{nil}
	...
	// 			Expect(context.DataRepositoryImpl.GetDataSetByIDInputs).To(Equal([]string{targetUpload.UploadID}))
	...
	// 			Expect(context.DataRepositoryImpl.DeleteDataSetInputs).To(Equal([]*upload.Upload{targetUpload}))
	...
	// 			context.DataRepositoryImpl.GetDataSetByIDOutputs = []testDataStoreDEPRECATED.GetDataSetByIDOutput{}
	...
	// 			context.DataRepositoryImpl.DeleteDataSetOutputs = []error{}
	...
	// 			context.DataRepositoryImpl.GetDataSetByIDOutputs = []testDataStoreDEPRECATED.GetDataSetByIDOutput{{DataSet: nil, Error: err}}
	// 			context.Context.AuthDetailsImpl.IsServerOutputs = []bool{}
	// 			context.Context.AuthDetailsImpl.UserIDOutputs = []string{}
	// 			context.PermissionClientImpl.GetUserPermissionsOutputs = []GetUserPermissionsOutput{}
	// 			context.DataDeduplicatorFactoryImpl.IsRegisteredWithDataSetOutputs = []testDataDeduplicator.IsRegisteredWithDataSetOutput{}
	...
	// 			context.DataRepositoryImpl.GetDataSetByIDOutputs = []testDataStoreDEPRECATED.GetDataSetByIDOutput{{DataSet: nil, Error: nil}}
	// 			context.Context.AuthDetailsImpl.IsServerOutputs = []bool{}
	// 			context.Context.AuthDetailsImpl.UserIDOutputs = []string{}
	// 			context.PermissionClientImpl.GetUserPermissionsOutputs = []GetUserPermissionsOutput{}
	// 			context.DataDeduplicatorFactoryImpl.IsRegisteredWithDataSetOutputs = []testDataDeduplicator.IsRegisteredWithDataSetOutput{}
	...
	// 			Expect(context.PermissionClientImpl.GetUserPermissionsInputs).To(Equal([]GetUserPermissionsInput{{context, authUserID, targetUserID}}))
	// 			Expect(context.DataDeduplicatorFactoryImpl.IsRegisteredWithDataSetInputs).To(Equal([]*upload.Upload{targetUpload}))
	// 			Expect(context.DataDeduplicatorFactoryImpl.NewRegisteredDeduplicatorForDataSetInputs).To(Equal([]testDataDeduplicator.NewRegisteredDeduplicatorForDataSetInput{{Logger: context.LoggerImpl, DataRepository: context.DataRepositoryImpl, DataSet: targetUpload}}))
	...
	// 			err := errors.New("other")
	// 			context.DataRepositoryImpl.DeleteDataSetOutputs = []error{err}
	// 			context.MetricClientImpl.RecordMetricOutputs = []error{}
	// 			v1.DataSetsDelete(context)
	// 			Expect(context.DataRepositoryImpl.GetDataSetByIDInputs).To(Equal([]string{targetUpload.UploadID}))
	// 			Expect(context.PermissionClientImpl.GetUserPermissionsInputs).To(Equal([]GetUserPermissionsInput{{context, authUserID, targetUserID}}))
