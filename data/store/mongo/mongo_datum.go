...
func (d *DatumRepository) CreateDataSet(ctx context.Context, dataSet *upload.Upload) error {
	if ctx == nil {
...
func (d *DatumRepository) UpdateDataSet(ctx context.Context, id string, update *data.DataSetUpdate) (*upload.Upload, error) {
	if ctx == nil {
		return nil, errors.New("context is missing")
	}
	if id == "" {
