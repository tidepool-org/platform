...
func (d *DataSetRepository) CreateDataSet(ctx context.Context, dataSet *upload.Upload) error {
	if ctx == nil {
...
func (d *DataSetRepository) upsertDataSet(ctx context.Context, id string, update *data.DataSetUpdate) (*upload.Upload, error) {
	if ctx == nil {
		return nil, errors.New("context is missing")
	}
	if id == "" {
