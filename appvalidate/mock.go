...
//
//	mockgen -build_flags=--mod=mod -destination=./mock.go -package=appvalidate github.com/tidepool-org/platform/appvalidate Repository,ChallengeGenerator
//
...
func (m *MockRepository) Get(ctx context.Context, f Filter) (*AppValidation, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetAttestationChallenge(ctx context.Context, f Filter) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) IsVerified(ctx context.Context, f Filter) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateAssertion(ctx context.Context, f Filter, u AssertionUpdate) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) UpdateAttestation(ctx context.Context, f Filter, u AttestationUpdate) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Upsert(ctx context.Context, v *AppValidation) error {
	m.ctrl.T.Helper()
